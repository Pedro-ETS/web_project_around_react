...
function Card({id, likes, link, name, ontrashCard, owner,onCardLike, card,onCardDelete}) {
...
const cardLikeButtonClassName = (`card__btn-love ${isLiked ? 'card__btn-love_activate' : ''}`); 
  ...
  function handleDeleteClick(){//funcion que elimina directamente
    onCardDelete(card);
  }
  ...
  return (
    <div id={id} className = "card">
      ...
      <img src = {link} className = "card__image" alt="Imagen de un hermoso paisaje" />
